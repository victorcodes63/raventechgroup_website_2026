  ...
  return (
    <section className="relative overflow-hidden border-t border-white/10 bg-white py-12 sm:py-16 md:py-20 text-black">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(255,169,31,0.16),_transparent_70%)]" />
        <div className="absolute inset-0 bg-[linear-gradient(120deg,rgba(255,169,31,0.1)_0%,transparent_45%,rgba(14,14,18,0.1)_85%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(255,255,255,0.05),_transparent_60%)]" />
        <div className="absolute inset-0 opacity-[0.16]" style={{ backgroundImage: 'radial-gradient(rgba(255,169,31,0.35) 1px, transparent 1px)', backgroundSize: '28px 28px' }} />
        <div className="absolute inset-0 opacity-[0.12]" style={{ backgroundImage: 'radial-gradient(rgba(255,169,31,0.18) 1.5px, transparent 1.5px)', backgroundSize: '140px 140px' }} />
      </div>
