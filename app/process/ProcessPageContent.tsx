...
export function ProcessPageContent() {
  ...
  return (
    <section ref={sectionRef} className="border-b border-white/[0.06] py-24 lg:py-32 xl:py-40">
      <div className="site-shell">
        ...
        <ol className="mt-16 hidden list-none grid-cols-1 gap-8 md:grid md:grid-cols-2 lg:grid-cols-4 lg:gap-12 xl:gap-16">
          {howWeWorkSteps.map(({ title, description }, index) => {
            const stepNo = String(index + 1).padStart(2, '0')
            return (
              <li
